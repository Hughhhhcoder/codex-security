...
test("loads each scan's matching findings once across historical batches", () => {
  ...
  const probe = [
    ...
    "CREATE TABLE scans (id TEXT, target_path TEXT, target_id TEXT, target_device TEXT, target_inode TEXT, status TEXT, started_at TEXT);",
    ...
    "    scan = f'scan-{index}'",
    "    connection.execute('INSERT INTO scans VALUES (?, ?, NULL, NULL, NULL, ?, ?)', (scan, repository, 'complete', str(index)))",
