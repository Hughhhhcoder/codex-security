...
const caseSensitiveWindowsHistoryProbe = [
  ...
  "    'caseSensitiveScopesMatch': cache.group(lower_scope['target_id']) == cache.group(upper_scope['target_id']),",
  "    'caseSensitiveRootsMatch': cache.group(lower_root['target_id']) == cache.group(upper_root['target_id']),",
  "    'linkedWorktreeMatches': cache.group(linked_scope['target_id']) == cache.group(upper_scope['target_id']),",
  "    'sameOriginCloneMatches': cache.group(clone_scope['target_id']) == cache.group(upper_scope['target_id']),",
