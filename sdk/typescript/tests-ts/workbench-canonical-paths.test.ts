...
const caseSensitiveWindowsHistoryProbe = [
  ...
  "history.verified_repository_identity = lambda connection, target_id, path, **kwargs: identities.get(str(path))",
  ...
  "    'caseSensitiveScopesMatch': history._same_repository(connection, lower_scope, upper_scope, after_identity=scope_group),",
  "    'caseSensitiveRootsMatch': history._same_repository(connection, lower_root, upper_root, after_identity=root_group),",
  "    'linkedWorktreeMatches': history._same_repository(connection, linked_scope, upper_scope, after_identity=scope_group),",
  "    'sameOriginCloneMatches': history._same_repository(connection, clone_scope, upper_scope, after_identity=scope_group),",
  "    'exactResolvedPathMatches': history._same_repository(connection, same_path, upper_scope, after_identity=scope_group),",
  "}",
